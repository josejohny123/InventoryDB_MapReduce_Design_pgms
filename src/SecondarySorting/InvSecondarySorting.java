...
public class InvSecondarySorting extends Configured implements Tool{
...
@Override
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(InvSecondarySortingMapper.class);
		...
		// Submit the job and get completion code.
				...
				if (code == 0) {
					...
					orderJob.setJarByClass(InvSecondarySorting.class);

					// Here, use the identity mapper to output the key/value pairs in
					// the SequenceFile
					orderJob.setMapperClass(Mapper.class);
					orderJob.setReducerClass(InvSecondarySortingReducer.class);
...
public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new InvSecondarySorting(), args);
